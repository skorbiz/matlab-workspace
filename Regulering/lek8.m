...
% Opgave 5.1 a er kontrolerbar, og derfor også stabil, det er derfor kun
% intteresant at se på 5.1 b
a = [0 1 0; 25 0 -1; 0 0 0];
b = [0 1 5]';
...
%Vi kan ikke påvirke x1, da U1 er lig 0. Hvis x1 dog i sig selv er stabil
%og henfalder, så kan vi stadig kalde systemet stabilt.
%Vi ser derfor på pol-placeringen, og ser det ikke er stabilt.
pzplot(sys)

%Ellers kan vi sige at et system er stabiliserbart, hvis alle egen værdier
%er negative (egen værdierne ligger på tværs i en modal matrix)

%% opgave 5.3
% Gør systemet contolerbar. Det gøres ved at fjerne den søjle og række vi
% ikke kan styre. Vi har så et systemt.

a = [-5 0; 0 0];
b = [0.3202; 5.004];

%Det kan kun gøres så let pga at matrixen er diagonaliseret.
%Det ses så på kontrobiliteten
